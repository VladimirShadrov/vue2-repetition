<template>
  <div>
    <h1 class="content__theme-title">Связь дочерних компонентов</h1>
    <br />

    <h3>Компонент: AppChildren.vue</h3>
    <br />
    ...
    <div class="wrapper">
      <test-car-1 :model="model" :year="year" @countPlus="changeCounter" />
      <my-global-counter :counter="counter" />
    </div>
  </div>
</template>
